...
const About = () => {
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gray-800 text-white pt-32 pb-24">
        ...
        <div className="container-custom relative px-6 text-center">
          ...
          <h1 className="mx-auto mt-6 max-w-3xl text-4xl font-extrabold tracking-tight text-white sm:text-5xl">
            ...
            <span className="block text-gray-300">for real businesses</span>
          </h1>
        ...
        <div className="container-custom px-6">
          <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 hidden rounded-2xl bg-gray-900 p-6 shadow-xl sm:block">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom px-6">
          <div className="relative overflow-hidden rounded-3xl bg-gray-900 px-8 py-16 text-center shadow-2xl sm:px-16">
            <div className="pointer-events-none absolute -left-16 -top-16 h-64 w-64 rounded-full bg-gray-300/20 blur-3xl" />
            <div className="pointer-events-none absolute -bottom-16 -right-16 h-64 w-64 rounded-full bg-gray-300/20 blur-3xl" />
